...
void main(void)
{
    ...
    outRand = smoothstep(0.4,1.0,outRand);
    float animNoise = (snoise(vec3(gl_PositionIn[0].x,gl_PositionIn[0].y,gl_PositionIn[0].z+(mTime*0.15))) + 1.0) * 0.5;
    animNoise = smoothstep(1.0-mGlow,1.0,animNoise);
    outColor = vec4(outRand,animNoise,1.0,1.0);
