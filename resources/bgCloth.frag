...
void main()
{
    ...
    float one = ( mod( trans, 4.0 ) );
    float two = ( mod( (trans+1.0), 4.0 ) );
    vec3 gradCol = vec3(1.0,0.0,0.0);
    
    vec3 colors[4];
    colors[0] = vec3( 0.2, 0.8, 1.0 ) *0.4;
    colors[1] = vec3( 0.8, 0.0, 1.0 )*0.4;
    colors[2] = vec3( 0.6, 0.8, 1.0 )*0.4;
    colors[3] = vec3( 0.8, 0.5, 0.8 )*0.4;
